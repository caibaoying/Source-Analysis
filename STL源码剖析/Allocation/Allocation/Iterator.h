...
// 返回迭代器的类型
template <class Iterator>
inline typename Iterator_Traits<Iterator>::IteratorCategory
IteratorCategory(const Iterator&)
{
	return Iterator_Traits<Iterator>::IteratorCategory();
}
...
{
	return static_cast<typename Iterator_Traits<Iterator>::DifferenceType*>(0);
}
...
{
	return static_cast<typename Iterator_Traits<Iterator>::ValueType*>(0);
}
